          ...
          KantaBai.com</a>
            ...
            <div class="collapse navbar-collapse " id="collapsenavbar">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item ">
                      <a href="baby.php"class="nav-link bg-dark text-white active">BabySitter</a>
                </li>
...
<h6>Search all the BABY SITTERS in your near by places</h6>
...
<div class="container text-center" >
  <h1 style="margin-top: 20px;font-family:century gothic;">BABY SITTERS</h1>
  <center>
   <div class="search container">   
    <form method="POST" action="baby.php">
  ...
  <?php
       ...
       { 
        ...
        $result = mysqli_query($con, "SELECT * FROM maid
          WHERE apply='Baby Sitters' AND (citySelect LIKE '%{$citySelect}%' OR location LIKE '%{$location}%')");
...
<div class="card container" style="width: 18rem;border:none;
    box-shadow: 5px 5px 25px -5px rgba(0,0,0,0.5);border-radius: 15px;margin-top: 20px; ">
  <div class="text-center">
  <img src="<?php echo $row['pic']; ?>" class="card-img-top mt-2" alt="..." style="height:180px; width:245px;">
   </div>
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-3 text-muted">Gender&nbsp;:&nbsp;<?php echo $row['gender'] ?> </h6>
    
    <button type="button" class="btn btn-outline-primary m-2">$500</button>
    <a href="login.php"><button type="button" class="btn btn-primary text-white"style="border-radius:4px;">
  Book Now
</button></a>
  </div>
</div>
