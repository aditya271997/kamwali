          ...
          KantaBai.com</a>
            ...
            <div class="collapse navbar-collapse " id="collapsenavbar">
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                      <a href="cook.php"class="nav-link text-white bg-dark active">Cook</a>
                </li>
                  <li class="nav-item">
...
<h6>Search all the COOK in your near by places</h6>
...
<div class="container text-center" >
  <h1 style="margin-top: 20px;font-family:century gothic;">Cooks</h1>
  <center>
  ...
  <?php
       ...
       { 
        ...
        $result = mysqli_query($con, "SELECT * FROM maid
          WHERE apply='Cook' AND (citySelect LIKE '%{$citySelect}%' OR location LIKE '%{$location}%')");
